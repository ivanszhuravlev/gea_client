...
import '../contours/contours_v1.pb.dart' as $0;
...
class AppFullInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AppFullInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'apps'), createEmptyInstance: create)
    ...
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..pc<$0.ContourInfo>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'contours', $pb.PbFieldType.PM, subBuilder: $0.ContourInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  factory AppFullInfo({
    ...
    $core.String? name,
    $core.String? description,
    $core.Iterable<$0.ContourInfo>? contours,
  }) {
    final _result = create();
    if (id != null) {
      _result.id = id;
    ...
    if (contours != null) {
      _result.contours.addAll(contours);
    }
    return _result;
  }
  ...
  @$pb.TagNumber(4)
  $core.List<$0.ContourInfo> get contours => $_getList(3);
}
