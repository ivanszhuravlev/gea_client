...
final $typed_data.Uint8List contoursListOptionDescriptor = $convert.base64Decode('ChJDb250b3Vyc0xpc3RPcHRpb24SFQoGYXBwX2lkGAEgASgJUgVhcHBJZA==');
...
final $typed_data.Uint8List contourIdAndNameDescriptor = $convert.base64Decode('ChBDb250b3VySWRBbmROYW1lEg4KAmlkGAEgASgJUgJpZBISCgRuYW1lGAIgASgJUgRuYW1lEhUKBmFwcF9pZBgDIAEoCVIFYXBwSWQ=');
...
const ContourInfoWithoutServices$json = const {
  ...
  '2': const [
    ...
    const {'1': 'app_id', '3': 4, '4': 1, '5': 9, '10': 'appId'},
  ],
};

/// Descriptor for `ContourInfoWithoutServices`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List contourInfoWithoutServicesDescriptor = $convert.base64Decode('ChpDb250b3VySW5mb1dpdGhvdXRTZXJ2aWNlcxIOCgJpZBgBIAEoCVICaWQSEgoEbmFtZRgCIAEoCVIEbmFtZRIgCgtkZXNjcmlwdGlvbhgDIAEoCVILZGVzY3JpcHRpb24SFQoGYXBwX2lkGAQgASgJUgVhcHBJZA==');
...
final $typed_data.Uint8List contourNameAndDescriptionDescriptor = $convert.base64Decode('ChlDb250b3VyTmFtZUFuZERlc2NyaXB0aW9uEhIKBG5hbWUYASABKAlSBG5hbWUSIAoLZGVzY3JpcHRpb24YAiABKAlSC2Rlc2NyaXB0aW9uEhUKBmFwcF9pZBgDIAEoCVIFYXBwSWQ=');
...
final $typed_data.Uint8List contourInfoDescriptor = $convert.base64Decode('CgtDb250b3VySW5mbxIOCgJpZBgBIAEoCVICaWQSEgoEbmFtZRgCIAEoCVIEbmFtZRIgCgtkZXNjcmlwdGlvbhgDIAEoCVILZGVzY3JpcHRpb24SLQoIc2VydmljZXMYBCADKAsyES5hcHBzLlNlcnZpY2VJbmZvUghzZXJ2aWNlcxIVCgZhcHBfaWQYBSABKAlSBWFwcElk');
...
const ServiceIdAndContourId$json = const {
  ...
  '2': const [
    const {'1': 'contour_id', '3': 1, '4': 1, '5': 9, '10': 'contourId'},
...
final $typed_data.Uint8List serviceIdAndContourIdDescriptor = $convert.base64Decode('ChVTZXJ2aWNlSWRBbmRDb250b3VySWQSHQoKY29udG91cl9pZBgBIAEoCVIJY29udG91cklkEh0KCnNlcnZpY2VfaWQYAiABKAlSCXNlcnZpY2VJZBIVCgZhcHBfaWQYAyABKAlSBWFwcElk');
...
const RepeatedServiceWithoutId$json = const {
  ...
  '2': const [
    const {'1': 'contour_id', '3': 1, '4': 1, '5': 9, '10': 'contourId'},
    const {'1': 'services', '3': 2, '4': 3, '5': 11, '6': '.apps.ServiceWithoutId', '10': 'services'},
    const {'1': 'app_id', '3': 3, '4': 1, '5': 9, '10': 'appId'},
  ],
};

/// Descriptor for `RepeatedServiceWithoutId`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List repeatedServiceWithoutIdDescriptor = $convert.base64Decode('ChhSZXBlYXRlZFNlcnZpY2VXaXRob3V0SWQSHQoKY29udG91cl9pZBgBIAEoCVIJY29udG91cklkEjIKCHNlcnZpY2VzGAIgAygLMhYuYXBwcy5TZXJ2aWNlV2l0aG91dElkUghzZXJ2aWNlcxIVCgZhcHBfaWQYAyABKAlSBWFwcElk');
@$core.Deprecated('Use repeatedServiceWithIdDescriptor instead')
const RepeatedServiceWithId$json = const {
  '1': 'RepeatedServiceWithId',
  '2': const [
    const {'1': 'contour_id', '3': 1, '4': 1, '5': 9, '10': 'contourId'},
    const {'1': 'services', '3': 2, '4': 3, '5': 11, '6': '.apps.ServiceInfo', '10': 'services'},
    const {'1': 'app_id', '3': 3, '4': 1, '5': 9, '10': 'appId'},
  ],
};

/// Descriptor for `RepeatedServiceWithId`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List repeatedServiceWithIdDescriptor = $convert.base64Decode('ChVSZXBlYXRlZFNlcnZpY2VXaXRoSWQSHQoKY29udG91cl9pZBgBIAEoCVIJY29udG91cklkEi0KCHNlcnZpY2VzGAIgAygLMhEuYXBwcy5TZXJ2aWNlSW5mb1IIc2VydmljZXMSFQoGYXBwX2lkGAMgASgJUgVhcHBJZA==');
