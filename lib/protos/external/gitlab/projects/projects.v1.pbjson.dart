...
const ProjectInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'web_url', '3': 4, '4': 1, '5': 9, '10': 'webUrl'},
    const {'1': 'avatar_url', '3': 5, '4': 1, '5': 9, '10': 'avatarUrl'},
    const {'1': 'readme_url', '3': 6, '4': 1, '5': 9, '10': 'readmeUrl'},
  ],
};

/// Descriptor for `ProjectInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List projectInfoDescriptor = $convert.base64Decode('CgtQcm9qZWN0SW5mbxIOCgJpZBgBIAEoA1ICaWQSEgoEbmFtZRgCIAEoCVIEbmFtZRIgCgtkZXNjcmlwdGlvbhgDIAEoCVILZGVzY3JpcHRpb24SFwoHd2ViX3VybBgEIAEoCVIGd2ViVXJsEh0KCmF2YXRhcl91cmwYBSABKAlSCWF2YXRhclVybBIdCgpyZWFkbWVfdXJsGAYgASgJUglyZWFkbWVVcmw=');
